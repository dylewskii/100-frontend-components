...
import "./globals.css";
import PathnameHeading from "@/components/pathname-heading";
...
export const metadata: Metadata = {
  title: "Frontend 100",
  description: "One hundred different frontend components.",
};
    ...
    <html lang="en">
      ...
      >
        <header className="flex justify-between px-12 py-8">
          <h1 className="font-bold uppercase">Frontend 100</h1>
          <svg
        ...
        <div className="items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
          <PathnameHeading />
          <main className="flex flex-col gap-8 items-center sm:items-start py-20">
            {children}
          </main>
        </div>
      </body>
