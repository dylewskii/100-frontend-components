...
export default function One() {
  return (
    <section className="flex flex-col items-center rounded-2xl shadow-lg bg-white h-[32rem] w-[24rem] text-black gap-8 pb-12">
      <header className="relative w-full flex items-center justify-center">
        ...
        <div className="rounded-full h-24 w-24 z-50 overflow-hidden mt-8">
          <img
